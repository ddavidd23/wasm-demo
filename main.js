...
var _f = Module['_f'] = makeInvalidEarlyAccess('_f');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['f'] != 'undefined', 'missing Wasm export: f');
  assert(typeof wasmExports['increment'] != 'undefined', 'missing Wasm export: increment');
  ...
  _f = Module['_f'] = createExportWrapper('f', 2);
  _increment = Module['_increment'] = createExportWrapper('increment', 0);
